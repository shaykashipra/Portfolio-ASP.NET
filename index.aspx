   ...
   <main>
    <article>
        ...
        <div class="container">
            ...
            <h1 runat="server" class="h1 shipratitle" id="shipratitle">Shayka Islam</h1>

            <div class="wrapper h2">
              <strong runat="server" class="strong strong_t1" id="strong_t1" data-letter-effect>Student</strong>
              <strong runat="server" class="strong strong_t2" id="strong_t2" data-letter-effect>Programmer</strong>
              <strong runat="server" class="strong strong_t3" id="strong_t3" data-letter-effect>Developer</strong>
            </div>

            <p runat="server" class="shipratext" id="shipratext">KUET CSE 2k20</p>
            ...
            <div class="socia-icons">
                 <a href="https://github.com/shaykashipra" class="social github"><i class='bx bxl-github bx-tada' style='color:#ffffff' ></i></a>
          ...
          <div class="about-content">
            ...
            <div class="wrapper has-before" data-reveal="right">
              ...
              <p runat="server" class="sectiontext" id="sectiontext">
                 I am a 3rd-year student pursuing Computer Science and Engineering at KUET. A passionate programmer with a keen interest in photography. Beyond coding, I enjoy capturing moments through my lens. I have garnered recognition, including prizes and medals, for my proficiency in debate and singing competitions. Eager to learn, grow, and contribute to the world of technology and creativity.
              </p>
